...
export default function OwnerDashboard() {
  ...
  // 🚨 ၃။ စောစောက အစ်ကိုပြတဲ့ <style> ကြီးကို ဒီအပေါ်မှာ လုံးဝ မထားရပါဘူး။ ဖျက်ပစ်လိုက်ပါ။
  // (တခြား မူရင်းကုဒ်တွေ အောက်မှာ ဆက်ရှိနေပါမယ်...)


  // 💎 Plan Tier ('Starter' | 'Enterprise')
  const [planTier, setPlanTier] = useState<'Starter' | 'Enterprise'>('Enterprise');
  // 💎 Plan Tier ('Starter' | 'Enterprise')
  const [currentPlan, setCurrentPlan] = useState<'Starter' | 'Enterprise'>('Enterprise');
    ...
    <div className="space-y-6 w-full max-w-7xl mx-auto p-4 transition-colors duration-200">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b pb-4" style={{ borderColor: 'var(--border-color)' }}>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* 👇 အစ်ကိုပြတဲ့ နေရာလေးကို Starter ရော Pro ပါ Lock မိအောင် အခုလိုလေး လဲပေးလိုက်ပါဗျာ */}
          <button 
